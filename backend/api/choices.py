...
# winner status
WINNING_INELIGIBLE_CHOICE = 'I'
WINNING_PENDING_CHOICE = 'P'
WINNING_APPROVED_CHOICE = 'A'
WINNING_REJECTED_CHOICE = 'R'

WINNING_STATUS_CHOICES = [
    (WINNING_INELIGIBLE_CHOICE, 'Ineligible'),
    (WINNING_PENDING_CHOICE, 'Pending'),
    (WINNING_APPROVED_CHOICE, 'Approved'),
    (WINNING_REJECTED_CHOICE, 'Rejected'),
]
